...
static int max98390_probe(struct snd_soc_component *component)
{
	...
	/*set IVADC_I_EN & IVADC_V_EN*/
	regmap_write(max98390->regmap, MAX98390_MEAS_EN, 0x03);
	
	/*set IV Channel Selection*/
	regmap_write(max98390->regmap, MAX98390_PCM_CH_SRC_2, 0x01);

	/*set TX source enable*/
	regmap_write(max98390->regmap, MAX98390_PCM_TX_EN_A, 0x03);

	/*set TX HIZ */
	regmap_write(max98390->regmap, MAX98390_PCM_TX_HIZ_CTRL_A, 0xfc);
	
	/*set AMP_DSP_EN*/
	//regmap_write(max98390->regmap, MAX98390_BROWNOUT_EN, 0x04);
