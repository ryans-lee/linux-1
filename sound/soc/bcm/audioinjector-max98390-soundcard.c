...
static int snd_audioinjector_max98390_soundcard_startup
...
static int snd_audioinjector_max98390_soundcard_hw_params
...
static struct snd_soc_ops snd_audioinjector_max98390_soundcard_ops = {
	.startup = snd_audioinjector_max98390_soundcard_startup,
	.hw_params = snd_audioinjector_max98390_soundcard_hw_params,
};

static int audioinjector_max98390_soundcard_dai_init
...
SND_SOC_DAILINK_DEFS(audioinjector_max98390,
	DAILINK_COMP_ARRAY(COMP_CPU("bcm2708-i2s.0")),
	DAILINK_COMP_ARRAY(COMP_CODEC("max98390.1-0038", "max98390-aif1")),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("bcm2835-i2s.0")));

static struct snd_soc_dai_link audioinjector_max98390_soundcard_dai[] = {
	{
		.name = "AudioInjector audio",
		.stream_name = "AudioInjector audio",
		.ops = &snd_audioinjector_max98390_soundcard_ops,
		.init = audioinjector_max98390_soundcard_dai_init,
		.dai_fmt = SND_SOC_DAIFMT_CBS_CFS | SND_SOC_DAIFMT_I2S
			   | SND_SOC_DAIFMT_NB_NF,
		SND_SOC_DAILINK_REG(audioinjector_max98390),
	},
};
...
static struct snd_soc_card snd_soc_audioinjector = {
	.name = "audioinjector-max98390-soundcard",
	.dai_link = audioinjector_max98390_soundcard_dai,
	.num_links = ARRAY_SIZE(audioinjector_max98390_soundcard_dai),
...
static int audioinjector_max98390_soundcard_probe(struct platform_device *pdev)
{
	...
	if (pdev->dev.of_node) {
		struct snd_soc_dai_link *dai =
			&audioinjector_max98390_soundcard_dai[0];
...
static const struct of_device_id audioinjector_max98390_soundcard_of_match[] = {
	{ .compatible = "ai,audioinjector-max98390-soundcard", },
	{},
};
MODULE_DEVICE_TABLE(of, audioinjector_max98390_soundcard_of_match);

static struct platform_driver audioinjector_max98390_soundcard_driver = {
	.driver = {
		.name = "audioinjector-max98390",
		.owner = THIS_MODULE,
		.of_match_table = audioinjector_max98390_soundcard_of_match,
	},
	.probe = audioinjector_max98390_soundcard_probe,
};

module_platform_driver(audioinjector_max98390_soundcard_driver);
